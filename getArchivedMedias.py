...
HASHTAGS = ['instacool']
IG_USERNAME = 'ebulatik'
IG_PASSWORD = '321@Insta!plop'
...
def get_myArchivedMedias():
    userId = cl.user_id_from_username(IG_USERNAME)
    medias = cl.user_archives()
    
    return list(dict([(media.pk, media) for media in medias]).values())
